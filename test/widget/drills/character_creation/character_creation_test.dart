...
void main() {
  ...
  testWidgets('Session starts with Character 1 label', (tester) async {
    await tester.pumpWidget(_wrap(const CharacterCreationStartScreen()));
    await tester.pump();
  ...
  testWidgets('Return pass shows Return label with no Generate Prompt button',
    ...
    // We can't easily inject settings into CharacterCreationStartScreen directly,
  ...
  // 6. Session completes after final return pass and returns to Start.
